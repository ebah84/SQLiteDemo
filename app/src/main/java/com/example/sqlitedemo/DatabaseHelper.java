...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public  boolean deleteOne(CustomerModel customerModel){
        // find customerModel in the database, if it found delete and return true
    ...
    public List<CustomerModel> getEveryone(){
        ...
        if (cursor.moveToFirst()){
            ...
            // if failure don't add anything to the list
        }

            // close both the cursor and the database (sqliteDatabase)
        cursor.close();
